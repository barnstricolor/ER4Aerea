...
namespace ER4Aerea
{
    partial class frmCliente
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.txtOcup = new ER4Aerea.UCTextBox();
            this.txtCel = new ER4Aerea.UCTextBox();
            this.txtTel = new ER4Aerea.UCTextBox();
            this.txtRg = new ER4Aerea.UCTextBox();
            this.txtCep = new ER4Aerea.UCTextBox();
            this.txtCpf = new ER4Aerea.UCTextBox();
            this.txtBairro = new ER4Aerea.UCTextBox();
